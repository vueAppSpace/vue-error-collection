<template>
  <div class="detail-box" v-if="foodDetail && foodDetail.name">
    <!-- 头像 -->
    <div class="box-avatar">
      <img :src="foodDetail.detail.re_org_cookbook_picture" />
      <div class="box-title">
    ...
    <div class="food-effect card">
      ...
      <div class="tags">
        <van-tag
          v-for="(item, index) of foodDetail.health"
          :key="index"
    ...
    <!-- 营养特点 -->
    <!-- {{ allData['营养特点'].length }} -->
    <div class="food-effect card" v-if="foodDetail.nutr && foodDetail.nutr.length > 0 && foodDetail.nutr[0].info">
      <div class="subtitle">
        <h6>营养特点</h6>
      ...
      <div class="tags">
        <van-tag
          v-for="(i, idx) of foodDetail.nutr"
          :key="idx"
    ...
    <div
      class="steps card"
      v-if="
        foodDetail.detail.re_org_cookbook_method_and_steps && foodDetail.detail.re_org_cookbook_method_and_steps != 0
      "
    >
      <h6>制作步骤</h6>
      <div class="content">
...
<script>
  ...
  import { queryFoodDetail, queryCookDetail, queryTagDetail, queryList1 } from "@/service/healthManagement";
