 ...
 * @LastEditTime: 2023-03-31 14:08:14
-->
<script>
...
<template>
  <div class="box">
    <van-cell-group>
      <van-cell title="个人信息" is-link @click="jumpTo('/profile?autoback=true')" />

      <!-- <van-cell title="上传体检报告" is-link @click="jumpTo('/upload-report?autoback=true&add=true')" /> -->
